...
include '../../modals/admin/announcement.php';
include '../../modals/admin/update_announcement.php';
include '../../modals/admin/take.php';
include '../../modals/admin/stop.php';
include '../../modals/admin/transfer.php';
