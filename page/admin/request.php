            ...
            <div class="card card-primary">
              ...
              <form>
                <div class="card-body">
                   <div class="row">
                    <div class="col-3">
                    <label>Name:</label> <input type="text" name="name" id="name" class="form-control" autocomplete="off">
                    </div>
                    <div class="col-3">
                    <label>Process:</label> 

                    <input type="text" list="list" name="process" id="process" class="form-control">
                    <datalist id="list" name="process">
                     ...
                     <div class="col-6">
                      ...
                      <p style="text-align:right;"><a href="#" class="btn btn-primary" onclick="load_request()">Search <i class="fa fa-search"></a></i></p>
                    </div>
                  </div>
                  <br>
                  <div class="row">
