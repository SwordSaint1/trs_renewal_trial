...
const get_take_req_details =(param)=>{
...
document.getElementById('id_take_req').value = id;
document.getElementById('id_training_code_take_req').value = training_code;
document.getElementById('shift_take_reqs').value = shift;
document.getElementById('start_date_take_reqs').value = start_date;
document.getElementById('end_date_take_req').value = end_date;
document.getElementById('start_time_take_req').value = start_time;
document.getElementById('end_time_take_req').value = end_time;
document.getElementById('location_take_req').value = location;
document.getElementById('trainer_take_req').value = trainer;
document.getElementById('slot_take_req').value = slot;
prev_req();
}
...
function export_take_req(table_id, separator = ',') {
